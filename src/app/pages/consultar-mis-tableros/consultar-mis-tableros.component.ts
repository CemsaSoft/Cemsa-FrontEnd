...
@Component({
  selector: 'app-consultar-mis-tableros',
  templateUrl: './consultar-mis-tableros.component.html',
  styleUrls: ['./consultar-mis-tableros.component.css']
})

export class ConsultarMisTablerosComponent implements OnInit {
