...
@Component({
  selector: 'app-registrar-alarma',
  templateUrl: './registrar-alarma.component.html',
  styleUrls: ['./registrar-alarma.component.css']
})
export class RegistrarAlarmaComponent implements OnInit {
